                                     ...
                                     void *Opaque)
{
    ...
    reg = qemu_fdt_getprop_cell_inherit(fdti->fdt, node_path, "reg", 0, false,
                                NULL);
...
static char *zynq7000_qspi_flash_node_clone(void *fdt)
{
    ...
    int ret = qemu_devtree_node_by_compatible(fdt, qspi_node_path,
                                              "xlnx,zynq-qspi-1.0");
    if (ret == 0) {
        int qspi_is_dual = qemu_fdt_getprop_cell_inherit(fdt, qspi_node_path,
...
static memory_info init_memory(void *fdt, ram_addr_t ram_size, bool zynq_7000)
{
    ...
    if (!qemu_fdt_getprop(fdt, "/memory", "compatible", NULL, NULL)) {
    ...
    if (zynq_7000) {
        ...
        do {
            ...
            if (mem_offset > 0 &&
                ...
                mem_container = qemu_fdt_getprop_cell_inherit(fdt, mem_node_path,
                                                      "container",
                                                      0, 0, NULL);
                ...
                reg_value = qemu_fdt_getprop_cell_inherit(fdt, mem_node_path,
                                                  "reg", 0, 0, NULL);
        ...
        if (mem_created == 0) {
            ...
            do {
                ...
                if (mem_offset > 0) {
                    ...
                    region_start = qemu_fdt_getprop_cell_inherit(fdt, mem_node_path,
                                                       "reg", 0, 0, NULL);
                    ...
                    region_size = qemu_fdt_getprop_cell_inherit(fdt, mem_node_path,
                                                         "reg", 2, 0, NULL);
                    ...
                    container_phandle = qemu_fdt_getprop_cell_inherit(fdt,
                                                              mem_node_path,
                                                              "container", 0,
                                                              0, NULL);
                    container_offset =
                    ...
                    ram_prop = qemu_fdt_getprop_cell_inherit(fdt, mem_node_path,
                                                     "qemu,ram", 0,
                                                     0, NULL);
